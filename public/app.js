...
import { socketInit, gui, leaderboard, minimap, moveCompensation, lag, getNow } from "./lib/socketInit.js";
...
(function (
    ...
    fetch("changelog.html", { cache: "no-cache" }).then(async ChangelogsHTMLFile => {
    ...
    window.onload = async () => {
        global.serverSelector = new browser();
        global.serverSelector.init();
        // Save forms
        ...
        document.getElementById("startButton").onclick = () => {
            if (global.serverSelector.isMultiserver) startGame();
        };
